...
def main():
    ...
    raw_url = "https://web.archive.org/web/20040724054104id_/http://eco.ket.jp:80/ecoket7_list.htm"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                if circle_url_tag and circle_url_tag.has_attr("href"):
                    circle_urls.append(circle_url_tag["href"].replace("https://web.archive.org/web/20040724054104/", ""))
