...
def main():
    ...
    raw_url = "https://web.archive.org/web/20020217224245id_/http://sakura.comike.to/ecoket/c_list2.htm"
    ...
    for table in tables:
        ...
        for row in table_rows:  # Skip header row
                ...
                if circle_url_tag and circle_url_tag.has_attr("href"):
                    circle_urls.append(circle_url_tag["href"].replace("https://web.archive.org/web/20020217224245/", ""))
